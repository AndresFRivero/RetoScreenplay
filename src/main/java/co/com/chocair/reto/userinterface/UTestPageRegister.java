package co.com.chocair.reto.userinterface;
...
public class UTestPageRegister extends PageObject {
    ...
    public static final Target WELCOME = Target.the("Message of welcome").located(By.xpath("//h1[contains(text(), 'Welcome to the world's largest community of freelance software testers!')]"));
}
